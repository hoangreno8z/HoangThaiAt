  ...
  "canonical_texts": [
    {
      ...
      "pinyin": "Phu hữu hình giả sinh ư vô hình, tắc Càn Khôn an tòng sinh? Cố viết: Hữu Thái Dịch, hữu Thái Sơ, hữu Thái Thủy, hữu Thái Tố. Thái Dịch giả, vị kiến khí dã; Thái Sơ giả, khí chi thủy dã; Thái Thủy giả, hình chi thủy dã; Thái Tố giả, chất chi thủy dã. Khí hình chất cụ nhi vị tương ly, cố viết Hỗn Luân. Hỗn Luân giả, ngôn vạn vật tương hỗn luân nhi vị tương ly dã. Thị chi bất kiến, thính chi bất văn, tuần chi bất đắc, cố viết Dịch dã.",
      "meaning": "Phàm vạn vật có hình tướng đều sinh ra từ cõi vô hình, vậy thì Càn Khôn (Trời Đất) từ đâu mà sinh ra? Cho nên cổ nhân dạy rằng: Có cõi Thái Dịch, có cõi Thái Sơ, có cõi Thái Thủy, có cõi Thái Tố. Thái Dịch là trạng thái nguyên sơ tuyệt đối, chưa từng xuất hiện Khí; Thái Sơ là điểm khởi đầu phát sinh của Khí; Thái Thủy là điểm khởi đầu phát sinh của Hình tướng; Thái Tố là điểm khởi đầu phát sinh của Thể Chất. Khi Khí, Hình và Chất đều đã hội tụ đầy đủ nhưng chưa hề phân tách, thì gọi là trạng thái Hỗn Luân (Hỗn Độn nguyên thủy). Hỗn Luân nghĩa là vạn vật hòa quyện mịt mùng chưa chia ranh giới. Nhìn thì không thấy sắc, lắng nghe thì không thấy tiếng, lần mò theo thì không nắm bắt được, cho nên gọi đó là DỊCH (sự biến hóa vô cùng vi diệu).",
      "source": "Dịch Vĩ: Càn Tạc Độ (易緯·乾鑿度) — Thượng Quyển"
    },
    {
      "hanzi": "易變而為一，一變而為七，七變而為九。九者，氣變之究也，乃復變而為一。一者，形變之始也。清輕者上為天，濁重者下為地。",
      "pinyin": "Dịch biến nhi vi nhất, nhất biến nhi vi thất, thất biến nhi vi cửu. Cửu giả, khí biến chi cứu dã, nãi phục biến nhi vi nhất. Nhất giả, hình biến chi thủy dã. Thanh khinh giả thượng vi thiên, trược trọng giả hạ vi địa.",
      "meaning": "Dịch biến hóa thành Một (Số 1 - Thái Cực thuần nhất), Một biến hóa thành Bảy (Số 7 - Thiếu Dương phát tiết), Bảy biến hóa thành Chín (Số 9 - Thái Dương cực điểm). Số Chín là nấc thang tột cùng của sự biến hóa khí cơ, rồi từ Chín lại quay vòng biến hóa trở về Một. Một là khởi điểm của sự biến hóa hình thể vật chất. Khi đó phần Khí trong trẻo nhẹ nhàng (Thanh khinh) thăng hoa bay lên ngưng tụ thành Trời; phần Khí vẩn đục nặng nề (Trược trọng) lắng đọng kết tụ xuống dưới thành Đất.",
      "source": "Dịch Vĩ: Càn Tạc Độ (易緯·乾鑿度) — Tiên Thiên Khí Hóa Quyển"
    }
  ],
  "scholarly_analysis": {
    "term_glossary": [
      {
        "term": "Thái Dịch (太易)",
        "plain_vn": "Cõi hư vô tịch mịch, tuyệt đối không có vật chất, không có năng lượng, chưa có Khí (未見氣). Là bản thể Vô Cực trước mọi sự bắt đầu."
      },
      {
        "term": "Thái Sơ (太初)",
        "plain_vn": "Giai đoạn năng lượng vi mô đầu tiên xuất hiện trong vũ trụ, điểm khởi sinh của Nguyên Khí (氣之始), nhưng chưa có hình tướng."
      },
      {
        "term": "Thái Thủy (太始)",
        "plain_vn": "Giai đoạn Khí ngưng tụ tạo ra đường nét, cấu trúc không gian và hình tướng sơ khai (形之始), nhưng chưa thành chất rắn đặc."
      },
      {
        "term": "Thái Tố (太素)",
        "plain_vn": "Giai đoạn vật chất bắt đầu kết tinh thành khối chất cụ thể (質之始), hội tụ đầy đủ Khí - Hình - Chất."
      },
      {
        "term": "Hỗn Luân (渾淪)",
        "plain_vn": "Trạng thái quả trứng vũ trụ nguyên thủy (Cosmic Egg / Hỗn Độn), khi Khí, Hình và Chất đã đầy đủ nhưng hòa lẫn chưa phân ranh giới Trời Đất."
      }
    ],
    "masters_views": [
      {
        "master": "Trịnh Huyền (Đông Hán)",
        "work": "Dịch Vĩ Càn Tạc Độ Chú",
        "perspective": "Ngũ Thái là nấc thang tất yếu của Đạo. Khí là gốc của Hình, Hình là vỏ của Chất. Trời Đất không thể tự nhiên đùng một cái sinh ra, mà phải tuần tự trải qua 5 giai đoạn tích lũy khí cơ vi tế."
      },
      {
        "master": "Liệt Ngự Khấu (Chiến Quốc)",
        "work": "Liệt Tử - Thiên Thụy",
        "perspective": "Cái sinh ra vạn vật thì bản thân nó không bị sinh ra; cái làm biến hóa vạn vật thì bản thân nó bất biến. Thái Dịch chính là cội rễ bất sinh bất diệt của càn khôn."
      }
    ]
  },
  "cosmological_stages": [
...
const AMDUONG_NGUHANH_PART_3 = {
    ...
    "term_glossary": [
      {
        ...
        "plain_vn": "Quy luật phân đôi phổ quát của vũ trụ: 1  →  2 (Lưỡng Nghi)  →  4 (Tứ Tượng)  →  8 (Bát Quái)  →  64 (Lục Thập Tứ Quái)."
      },
      {
  ...
  "cosmological_stages": [
    {
      "stage": "Phân Tầng 1: Thái Cực  →  Lưỡng Nghi (2^1 = 2)",
    ...
    {
      "stage": "Phân Tầng 2: Lưỡng Nghi  →  Tứ Tượng (2^2 = 4)",
    ...
    {
      "stage": "Phân Tầng 3: Tứ Tượng  →  Bát Quái (2^3 = 8)",
...
const AMDUONG_NGUHANH_PART_7 = {
  ...
  "cosmological_stages": [
    {
      "stage": "Quy Tắc 1: Chúng Thắng Quả  →  Thủy Khắc Hỏa",
    ...
    {
      "stage": "Quy Tắc 2: Tinh Thắng Kiên  →  Hỏa Khắc Kim",
    ...
    {
      "stage": "Quy Tắc 3: Cương Thắng Nhu  →  Kim Khắc Mộc",
    ...
    {
      "stage": "Quy Tắc 4: Chuyên Thắng Tán  →  Mộc Khắc Thổ",
    ...
    {
      "stage": "Quy Tắc 5: Thực Thắng Hư  →  Thổ Khắc Thủy",
