/**
 * DÒNG THỜI GIAN TIẾN HÓA VŨ TRỤ & LỊCH SỬ DỊCH LÝ (CHRONOLOGICAL TIMELINE)
 * Bổ sung vào COSMIC_DATA: 100% Tiếng Việt, phân chia danh mục rành mạch theo niên đại.
 */

// Bổ sung timeline vào COSMIC_DATA
COSMIC_DATA.timeline = [
  {
    era: "Thuở Hồng Hoang (Tiền Vật Chất)",
    period: "Vô Thủy Vô Chung",
    title: "Khởi Nguyên Bản Thể: Vô Cực -> Thái Cực",
  ...
  {
    era: "Thời Đại Đồ Đá Mới & Văn Minh Lúa Nước",
    period: "Khoảng 5000 - 3000 TCN",
    title: "Cội Nguồn Dịch Lý Phương Nam (Viêm Việt / Thần Nông)",
    category: "Cội Nguồn Việt",
    desc: "Cư dân trồng trọt lúa nước phương Nam quan sát chu kỳ con nước, sấm sét, mưa nắng và mặt trời để đúc kết ra nhịp điệu Âm Dương sơ khai. Huyền sử Mẹ Âu Cơ (Núi/Âm) và Cha Lạc Long Quân (Biển/Dương) mã hóa sự phân đôi cân bằng sinh thái.",
    tag: "Lạc Việt"
  },
  {
    era: "Thời Đại Phục Hy (Tiên Thiên)",
    period: "Khoảng 2800 TCN",
    title: "Hà Đồ & Tiên Thiên Bát Quái (Bản Thể Không Gian)",
