      ...
      <div class="hoidap-container">
        ...
        <section class="hoidap-hero">
          ...
          <p class="hoidap-hero-desc">
            ${this.activeChapter === 1 && !this.searchQuery.trim() ? 'Lập Cực Định Vị: học cách xác định điểm đo, phân biệt nước thực với đường và luồng đi lại, đọc nguồn cổ theo đúng phạm vi, rồi khảo sát từng địa cuộc.' : this.activeChapter === 2 && !this.searchQuery.trim() ? 'Khúc Thủy Chiết Xung: phân tích các địa cuộc đường uốn cong cửu khúc, cung lõm ngọc đái, cung lồi phản cung sát, đường gập chữ Z và sườn đồi dốc; phân tầng lực ly tâm và điểm mù giao thông.' : this.activeChapter === 3 && !this.searchQuery.trim() ? 'Kỳ Lộ Giao Xoa: phân tích các giao lộ chữ H, chữ Y, chữ T, ngã tư góc nhọn tiễn đao, bùng binh đa khẩu thành môn, ngã năm đa luồng và mũi tàu hợp lưu; phân tầng khí động học và an toàn giao thông đô thị.' : `Tổng tập một trăm địa cuộc thực chứng cổ bản: Giải mã toàn diện cơ chế Lai Thủy, Khứ Thủy, 
