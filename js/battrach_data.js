...
const BATTRACH_FENGSHUI_PART_2 = {
  ...
  "cosmological_stages": [
    ...
    },
    {
      ...
      "practical_manifestation": "Chồng Tây Tứ chọn nhà hướng Tây Bắc, vợ Đông Tứ đặt hướng bếp quay về hướng Đông Nam  →  Cả hai vợ chồng cùng đắc Cát tinh, gia đình hòa thuận giàu sang.",
  ...
  "cosmological_stages": [
    {
      ...
      "detailed_explanation": "Khi so sánh giữa Quẻ Chủ (Mệnh quái hoặc Tọa nhà) với Quẻ Hướng, nếu chỉ có MỘT HÀO DUY NHẤT bị biến đổi tính chất (từ Dương sang Âm hoặc từ Âm sang Dương):\n- THƯỢNG HÀO BIẾN (Hào 3 trên cùng đổi tính chất): Tạo ra sao SINH KHÍ (Tham Lang Mộc). Ví dụ: Quẻ Càn ☰ (Dương toàn bộ) biến hào trên cùng thành Âm  →  Ra Quẻ Đoài ☱  →  Càn gặp Đoài là Sinh Khí.\n- TRUNG HÀO BIẾN (Hào 2 ở giữa đổi tính chất): Tạo ra sao TUYỆT MỆNH (Phá Quân Kim). Ví dụ: Quẻ Càn ☰ biến hào giữa thành Âm  →  Ra Quẻ Ly ☲  →  Càn gặp Ly là Tuyệt Mệnh.\n- SƠ HÀO BIẾN (Hào 1 dưới cùng đổi tính chất): Tạo ra sao HỌA HẠI (Lộc Tồn Thổ). Ví dụ: Quẻ Càn ☰ biến hào dưới cùng thành Âm  →  Ra Quẻ Tốn ☴  →  Càn gặp Tốn là Họa Hại.",
    ...
    },
    {
      ...
      "detailed_explanation": "HAI TRƯỜNG HỢP CỰC ĐOAN TUYỆT ĐỐI:\n- TOÀN BIẾN (Cả 3 hào đều biến đổi hoàn toàn ngược lại): Tạo ra sao DIÊN NIÊN (Vũ Khúc Kim). Đây là sự phối hợp Âm Dương đối đãi hoàn hảo nhất trong Dịch học (Trời Đất giao hòa). Ví dụ: Quẻ Càn ☰ (3 hào Dương) biến toàn bộ thành 3 hào Âm  →  Ra Quẻ Khôn ☷  →  Càn gặp Khôn là Diên Niên (Càn Khôn phối hợp đại thọ cát tường).\n- TOÀN BẤT BIẾN (Cả 3 hào giữ nguyên y hệt nhau): Tạo ra sao PHỤC VỊ (Tả Phụ Hữu Bật). Tượng trưng cho sự tĩnh tại bất biến ban đầu. Ví dụ: Quẻ Càn ☰ gặp lại Quẻ Càn ☰  →  Là Phục Vị.",
  ...
  "cosmological_stages": [
    {
      ...
      "practical_manifestation": "Gia chủ Đông Tứ Mệnh đặt thân bếp tại hướng Tây Bắc (cung Tuyệt Mệnh) và quay miệng bếp về hướng Đông Nam (cung Sinh Khí)  →  Vừa triệt tiêu đại họa Tuyệt Mệnh, vừa đón trọn vẹn tài lộc Sinh Khí.",
...
if (typeof window !== 'undefined') {
  if (typeof BATTRACH_FENGSHUI_PART_1 !== 'undefined') window.BATTRACH_FENGSHUI_PART_1 = BATTRACH_FENGSHUI_PART_1;
  if (typeof BATTRACH_FENGSHUI_PART_2 !== 'undefined') window.BATTRACH_FENGSHUI_PART_2 = BATTRACH_FENGSHUI_PART_2;
  if (typeof BATTRACH_FENGSHUI_PART_3 !== 'undefined') window.BATTRACH_FENGSHUI_PART_3 = BATTRACH_FENGSHUI_PART_3;
  if (typeof BATTRACH_FENGSHUI_PART_4 !== 'undefined') window.BATTRACH_FENGSHUI_PART_4 = BATTRACH_FENGSHUI_PART_4;
  if (typeof BATTRACH_FENGSHUI_PART_5 !== 'undefined') window.BATTRACH_FENGSHUI_PART_5 = BATTRACH_FENGSHUI_PART_5;
  if (typeof BATTRACH_FENGSHUI_PART_6 !== 'undefined') window.BATTRACH_FENGSHUI_PART_6 = BATTRACH_FENGSHUI_PART_6;
  if (typeof BATTRACH_FENGSHUI_PART_7 !== 'undefined') window.BATTRACH_FENGSHUI_PART_7 = BATTRACH_FENGSHUI_PART_7;
  if (typeof BATTRACH_FENGSHUI_PART_8 !== 'undefined') window.BATTRACH_FENGSHUI_PART_8 = BATTRACH_FENGSHUI_PART_8;
  if (typeof BATTRACH_FENGSHUI_PART_9 !== 'undefined') window.BATTRACH_FENGSHUI_PART_9 = BATTRACH_FENGSHUI_PART_9;
  if (typeof BATTRACH_FENGSHUI_PART_10 !== 'undefined') window.BATTRACH_FENGSHUI_PART_10 = BATTRACH_FENGSHUI_PART_10;
}

if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    BATTRACH_FENGSHUI_PART_1: typeof BATTRACH_FENGSHUI_PART_1 !== 'undefined' ? BATTRACH_FENGSHUI_PART_1 : null,
    BATTRACH_FENGSHUI_PART_2: typeof BATTRACH_FENGSHUI_PART_2 !== 'undefined' ? BATTRACH_FENGSHUI_PART_2 : null,
    BATTRACH_FENGSHUI_PART_3: typeof BATTRACH_FENGSHUI_PART_3 !== 'undefined' ? BATTRACH_FENGSHUI_PART_3 : null,
    BATTRACH_FENGSHUI_PART_4: typeof BATTRACH_FENGSHUI_PART_4 !== 'undefined' ? BATTRACH_FENGSHUI_PART_4 : null,
    BATTRACH_FENGSHUI_PART_5: typeof BATTRACH_FENGSHUI_PART_5 !== 'undefined' ? BATTRACH_FENGSHUI_PART_5 : null,
    BATTRACH_FENGSHUI_PART_6: typeof BATTRACH_FENGSHUI_PART_6 !== 'undefined' ? BATTRACH_FENGSHUI_PART_6 : null,
    BATTRACH_FENGSHUI_PART_7: typeof BATTRACH_FENGSHUI_PART_7 !== 'undefined' ? BATTRACH_FENGSHUI_PART_7 : null,
    BATTRACH_FENGSHUI_PART_8: typeof BATTRACH_FENGSHUI_PART_8 !== 'undefined' ? BATTRACH_FENGSHUI_PART_8 : null,
    BATTRACH_FENGSHUI_PART_9: typeof BATTRACH_FENGSHUI_PART_9 !== 'undefined' ? BATTRACH_FENGSHUI_PART_9 : null,
    BATTRACH_FENGSHUI_PART_10: typeof BATTRACH_FENGSHUI_PART_10 !== 'undefined' ? BATTRACH_FENGSHUI_PART_10 : null,
  };
}
